        ...
        function AmazonButton() {
            ...
            if (available) {
                return (
                    <a
                        className="btn amzn"
                        href={currentBook.amzn}
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <i className="fab fa-amazon" /> Buy on Amazon
                    </a>
                );
            } else {
                return null;
        ...
        function AppleButton() {
            ...
            if (available) {
                return (
                    <a
                        className="btn apl"
                        href={currentBook.apl}
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <i className="fab fa-apple" /> Buy on iBooks
                    </a>
                );
            } else {
                return null;
        ...
        return (
            <div className="container">
                ...
                <div style={{ clear: "both" }}>
                    ...
                    {currentBook.reviews[0].review === "" ? null : (
                        <h3>
                            {`Reviews of `}
